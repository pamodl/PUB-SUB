...
public class MyClientAppTask2 {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            System.out.println("Usage: java MyClientAppTask2 <SERVER_IP> <SERVER_PORT> <CLIENT_TYPE>");
        ...
        try (
            ...
            System.out.println("Registered as: " + clientType);
            ...
            while ((userInput = consoleReader.readLine()) != null) {
                ...
                // Only print a new prompt if the client is still running
                if (isRunning) {
                    System.out.print("> ");
                }
            }
